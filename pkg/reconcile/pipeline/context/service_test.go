...
var _ = Describe("Service", func() {
	...
	DescribeTable("CRD exist", func(version string, gr schema.GroupResource) {
		...
		ns := "n1"
		service := &service{client: client, serviceRef: &apis.NamespacedRef{
			Namespace: &ns,
	...
	Describe("OwnedResources", func() {
		It("should return owned resources", func() {
			...
			impl := &service{client: client, resource: u, lookForOwnedResources: true, serviceRef: &apis.NamespacedRef{Namespace: &ns}}
